...
import { AppBar, Icon, IconButton, InputBase, Toolbar, useTheme, Button, Box, Typography, Menu, MenuItem } from '@mui/material';
...
const Navbar = ({
    ...
    const [ anchorEl, setAnchorEl ] = useState(null); // For the profile drop down
    const isOpen = Boolean(anchorEl)
    const handleClick = (event) => setAnchorEl(event.currentTargets);
    ...
    return <AppBar sx={{ 
        ...
        <Toolbar sx={{ justifyContent:'space-between' }}>
            ...
            <FlexBetween>
                ...
                {/* Gaps allows you to put gaps between each items and is a new alternative for margin left/right etc */}
            </FlexBetween>
                ...
                <FlexBetween>
                    <Button onClick={handleClick} sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", textTransform: "none", gap: '1rem' }}>
                        ...
                        <Box
                            ...
                            width="32px"
                            borderRadius="50%"
                            sx={{ objectFit: "cover" }} // Crops image as necessary to fit the space
                        />
